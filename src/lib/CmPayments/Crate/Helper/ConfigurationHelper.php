...
namespace CmPayments\Crate\Helper;
...
/**
 * The Crate schema file path.
 *
 * @var string
 */
define('CRATE_SCHEMA_FILE', CRATE_PATH . '/res/schema.json');
...
class ConfigurationHelper extends Helper
{
    ...
    public function loadFile($file = null)
    {
        ...
        $this->json->validate(
            $this->json->decodeFile(CRATE_SCHEMA_FILE),
            $json
        );
