...
Crate will manually extract and verify the phar's signature. If you
require that Crate handle the verification process, you will need
to use the <comment>--no-extension</comment> option.

<question>Why would I require that crate handle the verification process?</question>
...
Crate supports verifying private key signed phars without using
